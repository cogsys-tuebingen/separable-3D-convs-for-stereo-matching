...
parser.add_argument('--save_path', type=str, default='./prediction-result/', help="location to save result")
...
if __name__ == "__main__":
    ...
    if not os.path.exists(opt.save_path):
        ...
        print(f"making directory {opt.save_path}")
    ...
    for index in range(total_images):
        ...
        #TODO: add prediction code for Middbury, see old version for code there

        savename = opt.save_path + current_file[0: len(current_file) - 1]
        print(f"saving image {savename}")
